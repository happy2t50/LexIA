...
class AdminController {
   ...
   */
  async getPendingProfiles(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      const user = (req as any).user;
   ...
   */
  async validateProfile(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      const user = (req as any).user;
   ...
   */
  async getPendingReports(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      const user = (req as any).user;
   ...
   */
  async moderateContent(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      const user = (req as any).user;
